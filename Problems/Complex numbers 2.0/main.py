class ComplexNumber:
    ...
    def __truediv__(self, other):
        real = other.real_part / (other.real_part * other.real_part + other.im_part * other.im_part)
        imaginary = -other.im_part / (other.real_part * other.real_part + other.im_part * other.im_part)
        return ComplexNumber(real, imaginary) * self
